...
import com.app.manqla.view.websites.onlineservices.WebsiteOnlineAdapter
import dagger.android.support.DaggerAppCompatActivity
import dmax.dialog.SpotsDialog
import kotlinx.android.synthetic.main.activity_articles_screen.*
import javax.inject.Inject

class WebsiteStudentScreen : DaggerAppCompatActivity() {
    ...
    private lateinit var mAdapter: WebsiteStudentAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_website_student_screen)

        supportActionBar!!.setDisplayHomeAsUpEnabled(true)
        supportActionBar!!.title = "طلبة"
        supportActionBar?.setHomeAsUpIndicator(R.drawable.ic_baseline_chevron_right_24)

        mAdapter = WebsiteStudentAdapter()
        ...
        mAdapter.onItemClickListener = object :
            WebsiteStudentAdapter.OnItemClickListener {
            override fun setOnItemClickListener(data: Data) {
                val intent = Intent(this@WebsiteStudentScreen, WebSiteDetailsScreen::class.java)
    ...
    private fun getMubadraat() {
        ...
        //electronic_services
        websiteStudentViewModel.getWebsites(sharedPreferences.getString(Constants.ACCESS_TOKEN,"")!!, "students", pageNumber).observe(this,
